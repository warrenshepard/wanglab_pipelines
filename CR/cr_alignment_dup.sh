...
clumpify.sh \
    ...
    out1=deduplicated/${smallBase}_R1.fastq.gz \
    out2=deduplicated/${smallBase}_R2.fastq.gz  

gunzip deduplicated/${smallBase}_R1.fastq.gz
gunzip deduplicated/${smallBase}_R2.fastq.gz

bbduk.sh \
    in1=deduplicated/${smallBase}_R1.fastq \
    in2=deduplicated/${smallBase}_R2.fastq \
...
rm deduplicated/${smallBase}_R1.fastq*
rm deduplicated/${smallBase}_R2.fastq*
